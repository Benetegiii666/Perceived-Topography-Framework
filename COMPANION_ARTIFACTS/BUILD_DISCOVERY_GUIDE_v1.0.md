...
Listen for: The build lead's own review of discovery records from categories 1 through 12. This is an internal inventory step, not a stakeholder interview question. The answers come from the discovery outputs, not from a new conversation.
...
Listen for: The build lead's scoping judgment after reviewing all discovery outputs. This is a prioritization step, not a stakeholder question. The build lead determines what can be deferred without making the first phase useless.
